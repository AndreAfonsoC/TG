class CombustionChamber:
    def __init__(
            ...
            chi: float = 0.0,
            pressure_loss_factor: float = 1.0,
    ):
        """
        ...
        Args:
            ...
            t0_out (float): Temperatura total de saída (K).
            ...
            pressure_loss_factor (float, optional): Fator de perda de pressão (adimensional).
                                                    1.0 significa sem perdas. Padrão para 1.0.
        """
        self.t0_in = t0_in
        self.p0_in = p0_in
        self.eta = eta
        ...
        self.chi = chi
        self.pressure_loss_factor = pressure_loss_factor
    ...
    def get_total_pressure(self) -> float:
        ...
        """
        return self.p0_in * self.pressure_loss_factor
