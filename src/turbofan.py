...
class Turbofan:
    ...
    def __init__(self, config_dict):
        ...
        self.t_a = final_config.get("t_a", t_a_altitude)
        self.p_a = final_config.get("p_a", p_a_altitude / 1000)    # Divide por 1000 para passar para kPa
    ...
    def get_flight_speed(self):
        # return np.sqrt(self.gamma_inlet * self.mean_R_air * self.t_a)
